...
class controlPanel():
    def __init__(self, secondaryWindow):
        ...
        # Save and Load Label
        self.saveAndLoadLabel = tk.Label(self.saveAndLoadLabelFrame, text="File", height=2, background = "#8583D7" )
        self.saveAndLoadLabel.pack(side="left", padx = (4,6))
        # Save and Load buttons
        self.secondaryWindow.saveButton = tk.Button(self.saveAndLoadFrame, text="Save", command=self.DecreaseSplitNum, activebackground="white")
        self.secondaryWindow.saveButton.pack(side="left", padx=20)
        self.secondaryWindow.loadButton = tk.Button(self.saveAndLoadFrame, text="Load", command=self.DecreaseSplitNum, activebackground="white")
        ...
        self.splitNumberLabel = tk.Label(self.splitButtonLabelFrame, text="Split Panel", height = 2, background = "#8583D7")
        ...
        self.ChangePanelModeLabel = tk.Label(self.ChangePannelModeLabelFrame, text="Panel mode", height = 2, background = "#8583D7")
