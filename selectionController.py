...
class SelectionController:
  ...
  def splitHorizontally(self):
    ...
    for s in self.screens:
      s.divideHorizontally(num=self.mainWindow.buttonWidget.splitNumber)
    for p in self.panels:
      p.divideHorizontally(num=self.mainWindow.buttonWidget.splitNumber)


  def splitVertically(self):
    '''splits selected screen/panels a number of times vertically set by the split amount'''
    for s in self.screens:
      s.divideVertically(num=self.mainWindow.buttonWidget.splitNumber)
    for p in self.panels:
      p.divideVertically(num=self.mainWindow.buttonWidget.splitNumber)
